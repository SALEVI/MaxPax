...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/sign-in` | `/sign-in` | `/(tabs)/home/` | `/home/` | `/(tabs)/home` | `/(tabs)/` | `/(tabs)` | `/(tabs)/notifications/` | `/notifications/` | `/(tabs)/notifications` | `/(tabs)/notificationsScreen` | `/notificationsScreen` | `/(tabs)/sensors/` | `/sensors/` | `/(tabs)/sensors` | `/(tabs)/sensorsScreen` | `/sensorsScreen` | `/(tabs)/settings/` | `/settings/` | `/(tabs)/settings` | `/(tabs)/settingsScreen` | `/settingsScreen` | `/modal`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(tabs)/home/${SingleRoutePart<T>}` | `/home/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(tabs)/home/[category]`;
